module.exports = {
  configure: function(app, mongo, ObjectID, url, assert, dbb, db) {
    ...
    var add_project_api_module = require("../../models/v1/add_project_api_module")(
      mongo,
      ObjectID,
      url,
      assert,
      ...
      try {
        ...
        if (user_token) {
          if (
            ...
            req.body.hasOwnProperty("pathname") &&
            req.body.hasOwnProperty("headers") &&
            req.body.hasOwnProperty("body") &&
            req.body.hasOwnProperty("method") &&
            req.body.hasOwnProperty("response")
          ) {
            // Verify user_token
            add_user_module.verify_user_details(user_token, function(
              result,
              error,
              message
            ) {
              if (error) {
                ...
                add_project_api_module.add_project_api(
                  project_details,
